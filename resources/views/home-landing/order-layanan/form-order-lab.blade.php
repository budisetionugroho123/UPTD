                ...
                <form onsubmit="return submitOrderLab()" method="POST">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-12 col-lg-6 mb-3 mb-lg-5 order-3 order-lg-2">
                            ...
                            <input type="text" id="no_pic" name="no_pic" class="form-control">
                        ...
                        <div class="col-12 col-lg-6 mb-3 mb-lg-5 order-8 order-lg-8">
                            ...
                            <input type="text" id="tanggal_pengantaran" name="tanggal_pengantaran" class="form-control tanggal_pengantaran">   
